...
function formReclamos() {
  ...
  openModal('Agregar Reclamo/Sugerencia', '<form id="modalForm" data-table="reclamos" onsubmit="handleForm(event)">' +
    ...
    '</div>' +
    '<div class="form-group"><md-filled-text-field label="Asunto" name="asunto" placeholder="Ej: Ruido excesivo, Fuga de agua" type="textarea" rows="2" required style="width:100%"></md-filled-text-field></div>' +
